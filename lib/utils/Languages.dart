        ...
        home: SafeArea(
          child: Scaffold(
            ...
            appBar: AppBar(backgroundColor: Color(0xffEFF6FF),
              ...
              actions: [
                SizedBox(width: 35),
                Text('Back',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),SizedBox(width: 70),
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text('Languages',style: TextStyle(color: Colors.black,fontSize: 22,fontWeight: FontWeight.bold),
                    ),
                  ),Padding(
