      ...
      home: SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(backgroundColor: Color(0xffEFF6FF),
            ...
            title: Text('Personal',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
          ),
          body: SingleChildScrollView(
            child: Column(
              children: [
                Center(
                  child: (!istrue)?Container(height: 130,width: 150,decoration: BoxDecoration(
                      shape: BoxShape.circle,border: Border.all(color: Colors.brown.shade800)
                  ),child: Column(
                    children: [
                      Padding(
                      ...
                      Text('photo',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: Text('Name',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold),),
                ),
                Padding(
                ...
                Padding(
                  ...
                  child: Text('Birthday',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold),),
                ),
                Padding(
                  padding: const EdgeInsets.only(right: 15,left: 15),
                  child: TextField(
                ...
                Padding(
                  ...
                  child: Text('About me',style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold),),
                ),
                Padding(
                  padding: const EdgeInsets.only(right: 15,left: 15),
                  child: TextField(
